...
const cepStyle = document.getElementById("inputCep").style;
...
function validarCep(){
    ...
    // /(\d{5})-(\d{3})/
    let resultsCep = cepRegex.test(cepInput.value);

    let msg = document.getElementById("cep-error");

    if(cepInput.value == ""){
        // msg.style.display = "block";
        msg.innerHTML = "Campo obrigatório*";
        cepStyle.borderColor = "red";
        return false;
    }else if(resultsCep === false){
        // msg.style.display = "block";
