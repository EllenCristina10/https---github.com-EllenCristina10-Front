...
<form class="fonte">
    ...
    <div class="row align-items-center p-2">
        ...
        <div class="col">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="inlineFormInputGroupUsername" placeholder="Telefone">
            </div>
        </div>
    </div>
    {{--Linha 2--}}
    <div class="row align-items-center p-2">
        ...
        <div class="col">
            ...
            <div class="input-group">
                ...
                <input type="Date" class="form-control" id="inlineFormInputGroupUsername" placeholder="Data de Nascimento">
            </div>
        </div>
    </div>
    {{--Linha 3--}}
    <div class="row align-items-center p-2">
        {{--CPF--}}
        <div class="col">
            <label class="visually-hidden" for="inlineFormInputGroupUsername">CPF</label>
            <div class="input-group">
                <div class="input-group-text">
                ...
                <input type="number" class="form-control" id="inlineFormInputGroupUsername" placeholder="CPF">
            </div>
        </div>

        {{--Endereço--}}
        <div class="col">
            <label class="visually-hidden" for="inlineFormInputGroupUsername">Endereço</label>
            <div class="input-group">
                <div class="input-group-text">
                ...
                <input type="text" class="form-control" id="inlineFormInputGroupUsername" placeholder="Endereço">
            </div>
        </div>
    </div>
    {{--Linha 4--}}
    <div class="row align-items-center p-2">
        ...
        {{--Cidade--}}
        <div class="col">
            <label class="visually-hidden" for="inlineFormInputGroupUsername">Cidade</label>
            <div class="input-group">
                <div class="input-group-text">
                ...
                <input type="text" class="form-control" id="inlineFormInputGroupUsername" placeholder="Cidade">
            </div>
        </div>
    </div>
    {{--Linha 5--}}
    <div class="row align-items-center p-2">
        {{--CEP--}}
        <div class="col-6">
            <label class="visually-hidden" for="inlineFormInputGroupUsername">CEP</label>
            <div class="input-group">
                <div class="input-group-text">
                ...
                <input type="number" class="form-control" id="inlineFormInputGroupUsername" placeholder="CEP">
            </div>
        </div>
    </div>
</form>
