            ...
            <div class="col-sm-6">
                ...
                <div class="input-group">
                    <div class="input-group-text background-icon-color">
                        ...
                        <input type="text" class="form-control" id="NomeExercicio" placeholder="Nome do Exercício" pattern="[a-z A-Z àâÂÀòôÒÔèêÈÊìîÌÎùûÙÛ \s]+$" required>
            ...
            <div class="col-sm-6">
                ...
                <div class="input-group">
                    ...
                    <div class="form-floating">
                        ...
                        border-top-right-radius: 7px ;" id="descricaoExercicio"></textarea>
