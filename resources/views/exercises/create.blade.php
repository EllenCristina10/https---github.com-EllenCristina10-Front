            ...
            <div class="col-sm-6">
                <div class="input-group">
                    <div class="input-group-text background-icon-color">
                        ...
                        <input type="text" class="form-control" id="validationDefault01" placeholder="Nome do Exercício" pattern="[a-z A-Z àâÂÀòôÒÔèêÈÊìîÌÎùûÙÛ \s]+$" required>
            ...
            <div class="col-sm-6">
                <div class="input-group">
                    ...
                    <div class="form-floating">
                        <textarea class="form-control  h-100"  id="floatingTextarea2"></textarea>
